...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      coordinates {
          (0, 47)(40, 2)(45, 4)(50, 1)(55, 10)(60, 9)(65, 2)(70, 4)(75, 6)(80, 4)(85, 4)(90, 6)(95, 6)(100, 9)
        };
  ...
  \resizebox{\textwidth}{!}{
    ...
    \begin{tikzpicture}
      \begin{axis}[
        ...
        \addlegendentry{Before Relaxation}
        ...
        \addlegendentry{After Relaxation}
      \end{axis}
    \end{tikzpicture}
  }
...
\begin{figure}[H]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tikzpicture}[node distance=0.5cm]
      ...
      \node (post_alloc) [process, right=of post_check, xshift=0.5cm] {Post Allocate Lectures};
...
The experimental results of the allocation process are shown in \autoref{tab:overall_experimental_results}. In this process, each of the approaches defined in \autoref{sec:rectifying_unallocated_courses} are applied sequentially, incrementally improving the allocation results. The first column shows the experiment, the second column shows the number of allocated lectures as count of lectures and number of hours, the third column shows the number of unallocated lectures as count of lectures and number of hours, and the fourth column shows the average score of the allocated lectures as defined by the course-faculty fit metric.
...
\begin{table}[H]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|l|c|c|c|}
      ...
      \textbf{Post-Allocation}  & 154 (2540 hrs)                & 3 (66 hrs)                      & 3.60               \\ \hline
    \end{tabular}
  }
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot coordinates {(0,43) (10,0) (20,0) (30,0) (40,1) (50,4) (60,17) (70,8) (80,10) (90,9) (100,20) (110,0) (120,2) (130,0) (140,0) (150,0)};
      \addlegendentry{With Preallocate}

      \addplot coordinates {(0,16) (10,0) (20,0) (30,0) (40,0) (50,5) (60,14) (70,10) (80,21) (90,23) (100,23) (110,0) (120,2) (130,0) (140,0) (150,0)};
      \addlegendentry{Split}

      \addplot coordinates {(0,10) (10,0) (20,0) (30,0) (40,0) (50,4) (60,11) (70,8) (80,17) (90,23) (100,21) (110,1) (120,5) (130,5) (140,2) (150,7)};
      \addlegendentry{Overshoot}

      \addplot coordinates {(0,5) (10,0) (20,0) (30,0) (40,1) (50,5) (60,6) (70,6) (80,13) (90,14) (100,19) (110,8) (120,8) (130,16) (140,5) (150,8)};
      \addlegendentry{Remedy}

    \end{axis}
  \end{tikzpicture}
  \caption{Faculty Utilization at Different Stages of Allocation}
  \label{fig:faculty_utilization_at_different_stages_of_allocation}
\end{figure}

\section{Equal Misery: Equitable Overloading of Faculty to Ensure Allocation of Non-Critical Courses}

The allocation process defined in \autoref{sec:allocation_process} allocates the courses to the faculty members in a way that doesn't overload the faculty members. This is done by setting the workload limits of the faculty members, and ensuring that the workload of the faculty members doesn't exceed their workload limits. In exceptional cases where the workload limits of the faculty members are reached and the courses cannot be allocated, the workload limits of the faculty members are relaxed as defined in \autoref{sec:workload_limit_relaxation}. This is done because at the expense of bandwidth for teaching tutorials and labs for these faculty members, and in the worst case, the faculty members might be overloaded.
...
\begin{table}[H]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|l|c|c|c|}
      ...
      \textbf{Post-Allocation}  & 137 (2591)                    & 2 (15)                          & 3.66               \\ \hline
    \end{tabular}
  }
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}
    \begin{axis}[
      ...
      \addplot coordinates {(0, 20) (10, 0) (20, 0) (30, 0) (40, 2) (50, 5) (60, 5) (70, 2) (80, 4) (90, 3) (100, 17) (110, 14) (120, 13) (130, 13) (140, 9) (150, 7) (160, 0) (170, 0)};
      \addlegendentry{With Preallocate}

      \addplot coordinates {(0, 16) (10, 0) (20, 0) (30, 0) (40, 2) (50, 4) (60, 5) (70, 2) (80, 5) (90, 3) (100, 16) (110, 16) (120, 13) (130, 13) (140, 12) (150, 7) (160, 0) (170, 0)};
      \addlegendentry{Split}

      \addplot coordinates {(0, 14) (10, 0) (20, 0) (30, 0) (40, 2) (50, 4) (60, 5) (70, 2) (80, 5) (90, 3) (100, 16) (110, 16) (120, 13) (130, 13) (140, 12) (150, 7) (160, 1) (170, 1)};
      \addlegendentry{Overshoot}

      \addplot coordinates {(0, 12) (10, 0) (20, 0) (30, 0) (40, 3) (50, 5) (60, 4) (70, 4) (80, 6) (90, 4) (100, 15) (110, 12) (120, 7) (130, 15) (140, 7) (150, 10) (160, 6) (170, 4)};
      \addlegendentry{Remedy}

    \end{axis}
  \end{tikzpicture}
  \caption{Faculty Utilization with Equal Misery}
  \label{fig:faculty_utilization_equal_misery}
\end{figure}

\section{Summary}

In this chapter, we defined the various priorities that decide which faculty is suited to teach which course. We then defined the allocation problem and all of the constraints and objectives that it aims to optimize. Using this, we modelled the allocation process and used Hungarian Algorithm to solve the allocation problem. We further refined the allocation process, adding a mechanism to honour the workload limits, a mechanism to handle the management priority of allocating earlier year courses to the best faculty, before defining the cost-function which represents the priorities of the students and the faculty.
