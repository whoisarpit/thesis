...
\def\submissiondate{24 \submissionmonth, \submissionyear}
\def\plagiarismMode{false} % set to true to include plagiarism declaration page
...
\ifthenelse{\equal{\plagiarismMode}{true}}{
  \pagenumbering{roman}
}{
  {
      \singlespacing
