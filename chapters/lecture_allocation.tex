...
\begin{table}[H]
  \centering
  \resizebox{\textwidth}{!}{\begin{tabular}{|l|r|r|r|c|}
      \hline
      \textbf{}                   & \textbf{Assigned Lectures} & \textbf{Unassigned Lectures} & \textbf{\% Allocated} & \textbf{Avg Score} \\ \hline
...
\begin{table}[H]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|l|r|r|r|c|}
      \hline
      \textbf{}                & \textbf{Assigned Lectures} & \textbf{Unassigned Lectures} & \textbf{Allocated Hrs \%} & \textbf{Avg Score} \\ \hline
...
\begin{table}[H]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|l|r|r|r|c|}
      \hline
      \textbf{Experiment}           & \textbf{Assigned Lectures} & \textbf{Unassigned Lectures} & \textbf{\% Allocated} & \textbf{Avg Score} \\ \hline
