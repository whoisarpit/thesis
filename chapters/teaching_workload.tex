...
In the next chapter, the teaching workload, in conjunction with the RTS model will be used as the basis for the lecture allocation problem, during which it will establish the limits for the teaching workload of the faculty to ensure that the faculty is not overloaded with work.
